        ...
        <div className="bg-gradient-to-br from-nexus-dark/80 to-nexus-purple/30 p-8 md:p-12 rounded-2xl border border-nexus-blue/30 backdrop-blur-md">
          ...
          <div className="text-center mb-10">
            <div className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              <p className="mb-4">
                <span className="text-gradient-gold font-bold text-2xl">有用有用好评</span>
              </p>
              <p className="mb-4">
                <span className="font-bold">Nexus AI 只需299元，买断！终身！</span>
              </p>
              <p className="mb-4">
                <span className="font-bold">并享有30%代理分成收益，多一份副业收入。</span>
              </p>
              <p className="mb-4">
