        ...
        <div className="bg-gradient-to-br from-nexus-dark/80 to-nexus-purple/30 p-12 md:p-16 rounded-2xl border border-nexus-blue/30 backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-bold text-nexus-cyan mb-6">对话模型</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-nexus-cyan mb-6">图像模型</h3>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="bg-nexus-dark/50 p-4 rounded-lg border border-nexus-blue/20">
            ...
            <div className="text-center lg:text-left">
              <div className="text-lg md:text-xl text-white/90 mb-12 leading-relaxed">
                <p className="mb-6">
